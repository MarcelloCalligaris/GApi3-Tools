	...
	public class OpaqueGen : HandleBase {
		...
		public override void Generate (GenerationInfo gen_info)
		{
			...
			if (set_gvalue != null) {
                ...
                sw.WriteLine("\t\tstatic d_{0} {0} = GLibrary.FuncLoader.LoadFunction<d_{0}>(GLibrary.FuncLoader.GetProcAddress(GLibrary.GLibrary.Load({1}), \"{0}\"));", set_gvalue.CName, LibraryName);
				sw.WriteLine ();
