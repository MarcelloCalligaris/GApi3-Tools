	...
	public class EnumGen : GenBase {
		...
		public override void Generate (GenerationInfo gen_info)
		{
			...
			if (Elem.HasAttribute ("gtype")) {
				...
				sw.WriteLine ("\t\tstatic d_" + funcname + " " + funcname + " = GLibrary.FuncLoader.LoadFunction<d_" + funcname + ">(GLibrary.FuncLoader.GetProcAddress(GLibrary.GLibrary.Load(" + LibraryName + "), \"" + funcname + "\"));");
				sw.WriteLine ();
